...
namespace SimplePOS.Migrations
{
    ...
    [Migration("20240726003655_AddingOutwardAndStockbalancs")]
    partial class AddingOutwardAndStockbalancs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SimplePOS.Models.Inward", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            InwardId = 1,
                            Date = new DateTime(2024, 7, 26, 3, 36, 54, 733, DateTimeKind.Local).AddTicks(1870),
                            SupplierId = 1
                        });
                });
